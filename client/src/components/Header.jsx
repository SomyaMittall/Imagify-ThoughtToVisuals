...
//     return (
//         <div className="relative flex flex-col justify-center items-center text-center my-20 text-white mt-12 overflow-hidden">
...
//             {/* Tag */}
//             <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-1 rounded-full shadow-lg shadow-blue-900/40 animate-fadeIn z-10">
//                 <p className="text-sm font-medium">Best text to Image Generator</p>
//                 <img src={assets.star_icon} alt="" />
//             </div>

//             {/* Title */}
//             <h1 className="text-4xl max-w-[320px] sm:text-7xl sm:max-w-[650px] mx-auto mt-10 font-bold leading-tight">
//                 Turn Text to{" "}
...
//             <button className="relative sm:text-lg text-white w-auto mt-8 px-12 py-3 flex items-center gap-2 rounded-full shadow-lg shadow-purple-800/50 transition-transform hover:scale-105 overflow-hidden z-10">
//                 <span className="relative z-10 flex items-center gap-2">
//                     Generate Image
//                     <img className="h-6" src={assets.star_group} alt="" />
//                 </span>
//                 {/* Aurora moving shine */}
//                 <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-600 to-blue-500 opacity-70 animate-aurora"></div>
//             </button>
    ...
    return (
        ...
        >
            ...
            <button onClick={onClickHandler} className="relative sm:text-lg text-white w-auto mt-8 px-12 py-3 flex items-center gap-2 rounded-full shadow-lg shadow-purple-800/50 transition-transform hover:scale-105 overflow-hidden z-10">
                ...
                {/* Aurora moving shine */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-600 to-blue-500 opacity-70"></div>
            </button>
